...
public class ArticleDetailFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mPhotoView = (ImageView) mRootView.findViewById(R.id.article_toolbar_image);

        mFabButton = mRootView.findViewById(R.id.floating_favorite_button);
    ...
    private void bindViews() {
        ...
        appBarLayout = mRootView.findViewById(R.id.article_app_toolbar);
        setupToolbar();
    ...
    private void setupToolbar() {
        toolbar = mRootView.findViewById(R.id.article_toolbar);
    ...
    private void shouldDisplayHome() {
        boolean canGoHome = getFragmentManager().getBackStackEntryCount()>0;
        getFragmentManager().popBackStack();
        getActivityCast().getSupportActionBar().setDisplayHomeAsUpEnabled(canGoHome);
    }
}
